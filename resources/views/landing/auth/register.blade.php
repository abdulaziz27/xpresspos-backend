...
@section('title', 'Daftar - XpressPOS')
...
<form class="space-y-6" action="{{ route('landing.register.post') }}" method="POST">
    ...
    <div>
        ...
        <div class="relative">
            <input id="password" name="password" type="password" autocomplete="new-password" required 
                   class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-gray-900 placeholder-gray-500" 
    ...
    <div class="flex items-center">
        ...
        <label for="terms" class="ml-2 block text-sm text-gray-700">
            Saya setuju dengan 
            <a href="#" class="text-blue-600 hover:text-blue-500 transition-colors duration-300">Syarat & Ketentuan</a>
            dan 
            <a href="#" class="text-blue-600 hover:text-blue-500 transition-colors duration-300">Kebijakan Privasi</a>
        </label>
    </div>
