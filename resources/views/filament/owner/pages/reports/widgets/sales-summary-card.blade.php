        ...
        <div class="space-y-4">
            <div class="space-y-3">
                <div class="gap-8 w-full" style="display: grid; grid-template-columns: 1fr 1fr;">
                    ...
                    <span class="text-lg font-semibold text-gray-900 dark:text-white text-right">{{ $this->salesSummary['gross_sales'] ?? 'Rp 0' }}</span>
                </div>
                
                <div class="gap-8 w-full" style="display: grid; grid-template-columns: 1fr 1fr;">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Penjualan Bersih</span>
                    <span class="text-lg font-semibold text-success-600 dark:text-success-400 text-right">{{ $this->salesSummary['net_sales'] ?? 'Rp 0' }}</span>
                </div>
            </div>
