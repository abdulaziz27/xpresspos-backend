...
class CashFlowFilterWidget extends Widget implements HasForms
{
    ...
    protected string $view = 'filament.owner.pages.reports.widgets.cash-flow-filter-widget';

    public ?array $data = [];

    protected function getSessionKey(): string
    {
        return 'local_filter.cashflowreport.filters';
    }
    ...
    public function updatedData(): void
    {
        ...
        $this->dispatch('cash-flow-filter-updated');
    }
