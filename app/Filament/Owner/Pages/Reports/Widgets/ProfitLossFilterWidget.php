...
class ProfitLossFilterWidget extends Widget implements HasForms
{
    ...
    protected string $view = 'filament.owner.pages.reports.widgets.profit-loss-filter-widget';

    public ?array $data = [];

    protected function getSessionKey(): string
    {
        return 'local_filter.profitlossreport.filters';
    }
