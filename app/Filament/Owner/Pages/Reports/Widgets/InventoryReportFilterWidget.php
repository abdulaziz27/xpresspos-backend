...
class InventoryReportFilterWidget extends Widget implements HasForms
{
    ...
    protected string $view = 'filament.owner.pages.reports.widgets.inventory-report-filter-widget';

    public ?array $data = [];

    protected function getSessionKey(): string
    {
        return 'local_filter.inventoryreport.filters';
    }
